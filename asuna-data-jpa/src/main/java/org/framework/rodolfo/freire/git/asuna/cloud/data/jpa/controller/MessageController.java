package org.framework.rodolfo.freire.git.asuna.cloud.data.jpa.controller;

import org.framework.rodolfo.freire.git.asuna.cloud.data.jpa.model.Message;
import org.framework.rodolfo.freire.git.asuna.cloud.data.jpa.service.MessageService;
...
@CrossOrigin(origins = "*")
@RestController
@RequestMapping(value = "/data-jpa/message")
