...
export default {
  ...
  methods: {
    getAllMessage() {
      apiClient
          .get("/data-mongo-reactive-route/message")
          .then((res) => {
    ...
    getByIdMessage(id) {
      apiClient
          .get(`/data-mongo-reactive-route/message/${id}`)
          .then((res) => {
            this.results = res.data;
          })
          .catch((error) => {
    ...
    postMessage() {
      apiClient
          .post("/data-mongo-reactive-route/message",
              {
                message: ''
              }
          )
    ...
    updateMessage(id) {
      apiClient
          .put(`/data-mongo-reactive-route/message/${id}`,
              {
                message: ''
              }
          )
    ...
    deleteMessage(id) {
      apiClient
          .delete(`/data-mongo-reactive-route/message/${id}`)
          .then(() => {
            console.log('message')
          })
          .catch((error) => {
